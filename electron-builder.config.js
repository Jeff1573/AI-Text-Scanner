...
const config = {
  ...
  deb: {
    ...
    description: 'AI Text Scanner is a powerful desktop application that provides OCR and translation capabilities.',
    depends: ['libgtk-3-0', 'libnotify-dev', 'libnss3-dev', 'libxss1', 'libgconf-2-4', 'libxrandr2', 'libasound2-dev', 'libxtst6', 'libatspi2.0-0', 'libdrm2', 'libxcomposite1', 'libxdamage1']
  },
  ...
  rpm: {
    ...
    depends: ['gtk3', 'libnotify', 'nss', 'libXScrnSaver', 'GConf2', 'libXrandr', 'alsa-lib']
  },
